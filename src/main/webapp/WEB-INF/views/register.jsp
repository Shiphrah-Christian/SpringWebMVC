                        ...
                        <form action="registerUser" method="post" class="">
                            <div class="form-grid">
                                ...
                                <div class="input-field">
                                    ...
                                    <input type="text" name="contact" id="w3lSender" placeholder="" required="">
                                </div>
                                <div class="input-field">
                                    <label> Your email</label>
                                    <input type="email" name="email" id="w3lName" placeholder="" required="">
                                </div>
                                <div class="input-field">
                                    <label> Your address</label>
                                    <input type="text" name="address" id="w3lPhone" placeholder="" required="">
                                </div>
                                <div class="input-field">
