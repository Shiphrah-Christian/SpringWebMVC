      ...
      <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
              <ul class="navbar-nav ml-lg-5 mr-lg-auto">
                  ...
                  <li class="nav-item active">
                      <a class="nav-link" href="/SpringWebMVC">Book A Table <span class="sr-only">(current)</span></a>
                  </li>
                  <li class="nav-item active">
        ...
        <div class="container">
            <div class="top-map">
                <div class="row map-content-9">
                    <div class="col-lg-8">
                    <br>
                    <h3 class="title-left mb-3">Please Select Your Booking Details</h3> 
                          <form action="bookatable" method="post" class="">
                            <div class="form-grid">
                            <div class="input-field">
                             <label for="lang">Guest</label><br>
                            ...
                            <div class="input-field">
                                ...
                                <div class="input-field">
							        ...
							        <br>
							        <h3 class="title-left mb-3">Enter Guest Details</h3> 
							        <br>                           
                                <div class="input-field">
                                    <label> Your Name</label>
                                    <input type="text" name="name" id="w3lSender" placeholder="" required="">
                                </div>
                                <div class="input-field">
                                    <label>Your Email</label>
                                    <input type="email" name="email" id="w3lPhone" placeholder="" required="">
                                </div>
                                <div class="input-field">
                                    <label> Your Contact</label>
                                    <input type="text" name="contact" id="w3lSubject" placeholder="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 cont-details">
                        <address>
                            <h5 class="">Our Restaurent Address</h5>
